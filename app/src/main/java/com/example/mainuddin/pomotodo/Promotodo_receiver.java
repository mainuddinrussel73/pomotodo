...
import static com.example.mainuddin.pomotodo.Promotodo_service.isStart;
import static com.example.mainuddin.pomotodo.fragments.PomotodoFragment.prefs;
import static com.example.mainuddin.pomotodo.promodetail.circularProgressBar;
import static com.example.mainuddin.pomotodo.promodetail.circularProgressBar1;
import static com.example.mainuddin.pomotodo.promodetail.circularProgressBar11;
import static com.example.mainuddin.pomotodo.promodetail.circularProgressBar12;
import static com.example.mainuddin.pomotodo.promodetail.circularProgressBar13;
import static com.example.mainuddin.pomotodo.promodetail.circularProgressBar14;
import static com.example.mainuddin.pomotodo.promodetail.circularProgressBar2;
import static com.example.mainuddin.pomotodo.promodetail.circularProgressBar3;
import static com.example.mainuddin.pomotodo.promodetail.circularProgressBar4;
import static com.example.mainuddin.pomotodo.promodetail.curr;
import static com.example.mainuddin.pomotodo.promodetail.fab;
import static com.example.mainuddin.pomotodo.promodetail.shake;
import static com.example.mainuddin.pomotodo.promodetail.textView1;
import static com.example.mainuddin.pomotodo.promodetail.textView2;
import static com.example.mainuddin.pomotodo.promodetail.textView3;
import static com.example.mainuddin.pomotodo.promodetail.titletask;
...
public class Promotodo_receiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(PAUSE_TIME)) {
            ...
            if (!taskInfo.get(0).topActivity.getClassName().equals("com.example.mainuddin.promotodo.promodetail")) {
    ...
    private void updateGUI(Context context, Intent intent) {
        ...
        if (intent.getExtras() != null) {
            ...
            if (millisUntilFinished != 0) {
                ...
                int k = PomotodoFragment.promotododataList.get(ccc).getISREPEAT();
                String s = PomotodoFragment.promotododataList.get(ccc).getTitle();

                String d = PomotodoFragment.promotododataList.get(ccc).getDue_date();
                //int c = PomotodoFragment.promotododataList.get(ccc).getCompleted_promotodo();
                //int n = PomotodoFragment.promotododataList.get(ccc).NUM;

                PomotodoFragment.mDBHelper.updateNum(ccco.getTitle(), ccco.getNum_of_promotodo() - 1);
                PomotodoFragment.mDBHelper.updateCompleted(ccco.getTitle(), ccco.getCompleted_promotodo() + 1);
                p = PomotodoFragment.promotododataList.get(ccc).getNum_of_promotodo() - 1;
                PomotodoFragment.promotododataList.get(ccc).setNum_of_promotodo(p);


                //int sub = prefs.getInt("t",0);


                int t = PomotodoFragment.promotododataList.get(ccc).getCompleted_promotodo() + 1;


                PomotodoFragment.promotododataList.get(ccc).setCompleted_promotodo(t);


                int c = PomotodoFragment.promotododataList.get(ccc).getCompleted_promotodo();
                int n = c + PomotodoFragment.promotododataList.get(ccc).getNum_of_promotodo();
                ...
                if (p <= 0) {
                    ...
                    promotododata promotododata = PomotodoFragment.promotododataList.get(ccc);
                    int i = PomotodoFragment.mDBHelper.deleteData(PomotodoFragment.promotododataList.get(ccc).getTitle());
                    PomotodoFragment.promotododataList.remove(ccc);
                    if (k == 1) {
                        LocalDate parsedDate = LocalDate.parse(d); //Parse date from String
                        LocalDate addedDate = parsedDate.plusDays(1);
                        String str = addedDate.format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
                        boolean b = PomotodoFragment.mDBHelper.insertAll(s, k, n, str, c);
                        if (b == true) {
                            ...
                            PomotodoFragment.promotododataList.add(PomotodoFragment.promotododataList.size(), promotododata);
                            //PomotodoFragment.mAdapter.notifyDataSetChanged();
                    ...
                    try {
                        myIntent.setClassName(context.getApplicationContext().getPackageName(), "PomotodoFragment");
                    ...
                    if (curr == ccc) {
                        ...
                        //PomotodoFragment.mDBHelper.updateCompleted(currenttask.getTitle(),1);
                    ...
                    //promodetail.fab1.setImageResource(R.drawable.ic_play_arrow_black_24dp);
                    //toogle=!toogle;
                    if (taskInfo.get(0).topActivity.getClassName().equals("com.example.mainuddin.promotodo.promodetail") && !promodetail.toogleview) {
                ...
                boolean b = mDBHelper.insertAll(ccco.getTitle(),
                        ccco.getISREPEAT()
                        , ccco.getNum_of_promotodo(), str
                        , ccco.getCompleted_promotodo(), Promotodo_service.start, end);


                SharedPreferences.Editor editor;
                editor = prefs.edit();
                int collected = prefs.getInt("collected", 0);
